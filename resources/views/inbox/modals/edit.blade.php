    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="edit_set_modal_title" style="margin-top: 15px;"></h4>
            </div>
            <div class="modal-body">
                ...
                <div class="tabbable-line boxless tabbable-reversed">
                    <ul class="nav nav-tabs" id="">
                        ...
                        <li>
                            <a href="#tab_proveedor_content" id="tab_3" data-toggle="tab"> Nuevo Proveedor </a>
                        </li>
                    </ul>
                    <div class="row">
                        <div class="tab-content col-md-8" style="padding-top: 2px">
                            ...
                            <div class="tab-pane " id="tab_proveedor_content"></div>
                        </div>
