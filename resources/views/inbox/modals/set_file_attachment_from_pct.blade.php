<div class="modal fade bs-modal" id="set_file_attachment_from_pct_modal" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                'id' => 'set_file_attachment_from_pct_form']) !!}
                <div id="set_file_attachment_from_pct_error_messages"></div>
                <div id="set_file_attachment_from_pct_success_message"></div>
                ...
                {!! Form::close() !!}
                <div class="row set-file-attachment-from-pct" style="padding: 0 10px 0 10px">
