...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('supplier.index') }}">Selectlist</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <span>{{ $action }} Selectlist</span>
    </li>
</ul>
@endsection
@section('page-title')
<h1 class="page-title"> {{ $action }} Selectlist
    <small></small>
</h1>
                ...
                <div class="tab-pane " id="tab_0_content">
                  <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="{{ route('selectlistauth.store') }}" method="POST" id="basic_form" class="horizontal-form">
